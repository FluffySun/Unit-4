...
//:END OF STILL DECIDING
  
  //butterfly(50,100); how do i add more butterflies
  
int i = 0;
while(i < 5) {
    butterfly(random(50 + i*200, 150 + i*200), random(35, 200));
    i = i + 1;
}

//KEEP BELOW:

//butterfly(random(50, 150), random(35, 200));
//butterfly(random(250, 350), random(35, 200));
//butterfly(random(450, 550), random(35, 200));
//butterfly(random(650, 750), random(35, 200));
//butterfly(random(850, 950), random(35, 200));
...
//i=i+1;
//}
//Unit 4 part of it->review(quiz->count hair)
...
//no longer needed:flower(random(50, 150), random(500, 700));
//flower(random(250, 350), random(500, 700));
//flower(random(450, 550), random(500, 700));
//flower(random(550, 650), random(500, 700));
//flower(random(750, 850), random(500, 700));
//flower(random(950, 1050), random(500, 700));
//
